...
<title>Harmony ~ Contact Us</title>
<!--  Bootstrap V5.1.3 -->
<link
...
<!-- CSS -->
<link rel="stylesheet"
	href="<c:url value="/resources/css/ContactUsPage.css"/>">
<!-- Browser Icon -->
...
<body>
	...
	<section class="page-section" id="contact"
		style="background-image: linear-gradient(#fb9900, #5cc49b);">
		<div class="container px-4 px-lg-5">
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-lg-8 col-xl-6 text-center">
					<h2 class="text-white mt-0 pt-5">Let's Get In Touch!</h2>
					<hr class="divider" style="background-color: #5ec79c;" />
					<p class="text-white mb-5">Questions? Send us a messages and we
			...
			<div class="row gx-4 gx-lg-5 justify-content-center mb-5">
				<div class="col-lg-6">
					...
					<form id="contactForm" data-sb-form-api-token="API_TOKEN">
						...
						<!-- Submit Button-->
						<div class="d-grid">
							<button class="btn btn-xl btn-rounded text-white"
